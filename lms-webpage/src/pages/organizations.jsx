...
const Student = () => {
  ...
  const studentsData = [
    { id: 1, name: 'Sample Institute', userId: '#s98765', email: 'John@example.com', Students_Count: '886', Instructors_Count: '25', Created_date: '12/05/25', status: 'Active', avatar: '/images/img_frame_5518_35x35.png' },
    { id: 2, name: 'Sample Institute', userId: '#s987re', email: 'John@example.com', Students_Count: '567 ',Instructors_Count: '23', Created_date: '12/05/25', status: 'Inactive', avatar: '/images/img_frame_5518_1.png' },
    { id: 3, name: 'Sample Institute', userId: '#s98455', email: 'John@example.com', Students_Count: '567', Instructors_Count: '21', Created_date: '12/05/25', status: 'Suspended', avatar: '/images/img_frame_5518_2.png' },
    { id: 4, name: 'Sample Institute', userId: '#s98765', email: 'John@example.com', Students_Count: '464', Instructors_Count: '12', Created_date: '12/05/25', status: 'Active', avatar: '/images/img_frame_5518_3.png' },
    { id: 5, name: 'Sample Institute', userId: '#s98765', email: 'John@example.com', Students_Count: '633', Instructors_Count: '21', Created_date: '12/05/25', status: 'Inactive', avatar: '/images/img_frame_5518_4.png' },
    { id: 6, name: 'Sample Institute', userId: '#s987re', email: 'John@example.com', Students_Count: '434', Instructors_Count: '12', Created_date: '12/05/25', status: 'Active', avatar: '/images/img_frame_5518_5.png' },
    { id: 7, name: 'Sample Institute', userId: '#s98455', email: 'John@example.com', Students_Count: '434', Instructors_Count: '12', Created_date: '12/05/25', status: 'Inactive', avatar: '/images/img_frame_5518_6.png' },
    { id: 8, name: 'Sample Institute', userId: '#s98765', email: 'John@example.com', Students_Count: '463', Instructors_Count: '12', Created_date: '12/05/25', status: 'Suspended', avatar: '/images/img_frame_5518_7.png' },
  ];
  ...
  const handleAddUser = () => { navigate('/addorganizations'); };
      ...
      <div className="flex-grow-1">
        ...
        <main
          ...
          <div className="d-flex justify-content-between align-items-center mb-4">
            <h2 className="h4 mb-0 text-secondary-gray">Organizations</h2>
            <div className="d-flex gap-4">
              ...
              <button className="btn btn-primary bg-primary-purple text-primary-white d-flex align-items-center gap-1" onClick={handleAddUser}>
                <img src="/images/img_frame_white_a700.svg" alt="Add" className="w-4 h-4" /> Add Organization
              </button>
            </div>
          </div>
              ...
              <table className="table table-hover align-middle">
                <thead>
                  <tr className="txt-gray">
                    <th className="py-2 px-3">Organization Name</th>
                    <th className="py-2 px-3">Admin Email ID</th>
                    <th className="py-2 px-3">Students Count</th>
                    <th className="py-2 px-3">Instructors Count</th>
                ...
                <tbody>
                  {studentsData.map((student) => (
                    <tr key={student.id}>
                      ...
                      <td className="py-2 px-3 text-secondary-gray">{student.Students_Count}</td>
                      <td className="py-2 px-3 text-secondary-gray">{student.Instructors_Count}</td>
                      <td className="py-2 px-3 text-secondary-gray">{student.Created_date}</td>
