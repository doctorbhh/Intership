...
const instructors = () => {
  ...
  const instructorsData = [
    { id: 1, name: 'John', userId: '#s98765', course: 'UI/UX Designing', organization: '10', price: '$3450', role: 'Instructor', status: 'Active', avatar: '/images/img_frame_5518_35x35.png' },
    { id: 2, name: 'Jude Mariyah', userId: '#s987re', course: 'Machine Learning & AI', organization: '20', price: '$3450', role: 'Admin', status: 'Inactive', avatar: '/images/img_frame_5518_1.png' },
    { id: 3, name: 'Ben Tension', userId: '#s98455', course: 'Python', organization: '24', price: '$3450', role: 'Instructor', status: 'Active', avatar: '/images/img_frame_5518_2.png' },
    { id: 4, name: 'Mary Rawan Rose', userId: '#s98765', course: 'Java Script', organization: '42', price: '$3450', role: 'Admin', status: 'Active', avatar: '/images/img_frame_5518_3.png' },
    { id: 5, name: 'John', userId: '#s98765', course: 'Python', organization: '15', price: '$3450', role: 'Instructor', status: 'Inactive', avatar: '/images/img_frame_5518_4.png' },
    { id: 6, name: 'Jude Mariyah', userId: '#s987re', course: 'UI/UX Designing', organization: '27', price: '$3450', role: 'Admin', status: 'Active', avatar: '/images/img_frame_5518_5.png' },
    { id: 7, name: 'Ben Tension', userId: '#s98455', course: 'Python', organization: '50', price: '$3450', role: 'Student', status: 'Inactive', avatar: '/images/img_frame_5518_6.png' },
    { id: 8, name: 'John', userId: '#s98765', course: 'Machine Learning & AI', organization: '19', price: '$3450', role: 'Instructor', status: 'Suspended', avatar: '/images/img_frame_5518_7.png' },
  ];
          ...
          <div className="card border-0 shadow-sm">
            ...
            <div className="table-responsive">
              <table className="table table-hover align-middle">
                ...
                <tbody>
                  {instructorsData.map((transactions) => (
                    <tr key={transactions.id}>
                      <td className="py-2 px-3">
                        <div className="d-flex align-items-center">
                          <img src={transactions.avatar} alt={transactions.name} className="rounded-circle me-2" style={{ width: '32px', height: '32px' }} />
                          <div>
                            <div className="text-secondary-gray">{transactions.name}</div>
                            <small className="text-muted">{transactions.userId}</small>
                          </div>
                        </div>
                      </td>
                      <td className="py-2 px-3 text-secondary-gray">{transactions.course}</td>
                      <td className="py-2 px-3 text-secondary-gray">{transactions.organization}</td>
                      
                      <td className="py-2 px-3 text-secondary-gray">{transactions.role}</td>
                      <td className="py-2 px-3 text-secondary-gray">{transactions.price}</td>
                      <td className="py-2 px-3">{getStatusBadge(transactions.status)}</td>
                      <td className="py-2 px-3">
                        <div className="d-flex gap-2">
                          <button className="btn p-1" onClick={() => handleViewStudent(transactions.id)}>
                            <img src="/images/img_frame_indigo_50.svg" alt="View" className="w-5 h-5" />
                          </button>
                          <button className="btn p-1" onClick={() => handleEditStudent(transactions.id)}>
                            <img src="/images/img_vector_green_a700.svg" alt="Edit" className="w-4 h-4" />
                          </button>
                          <button className="btn p-1" onClick={() => handleDeleteStudent(transactions.id)}>
